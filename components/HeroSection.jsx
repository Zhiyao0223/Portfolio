          ...
          >
            <h1 className="font-extrabold">
              ...
              <TypeWritter
                ...
                onInit={(typewriter) => {
                    typewriter
                    .typeString`<span style="color:#FF77FF">Software Developer</span>`
                    .pauseFor(1500)
                    .deleteAll()
                    .typeString`<span style="color:#9E7BFF">AI Specialist</span>`
                    .pauseFor(1500)
                    .deleteAll()
            ...
            <p className="text-gray-300 pt-8 text-base sm:text-lg mb-6 lg:text-xl">
              ...
              <Link
                href="https://drive.google.com/file/d/1bsBMtfU6XroDcSBJj7-DGak6xK1Tyrk3/view?usp=sharing"
